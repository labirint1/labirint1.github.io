...
//display notifi if cookie !=off
  if (getCookie("notifiVk")=='off') {
    ...
    }, 6000);//timeout before push
  }
//load content.notifi
  function loadContent(element_id) {
    if (document.getElementById(element_id)) {
      document.getElementById(element_id).innerHTML =
      '<div class="notifier"><div id="X"></div><div id="notifier_close""></div><div id="vk_subscribe"></div></div>     <script type="text/javascript">VK.Widgets.Subscribe("vk_subscribe", {soft: 1}, -65417535);VK.Widgets.Subscribe("vk_subscribe", {soft: 1}, -65417535);VK.Widgets.Subscribe("vk_subscribe", {soft: 1}, -65417535);VK.Widgets.Subscribe("vk_subscribe", {soft: 1}, -65417535);VK.Widgets.Subscribe("vk_subscribe", {soft: 1}, -65417535);VK.Widgets.Subscribe("vk_subscribe", {soft: 1}, -65417535);VK.Widgets.Subscribe("vk_subscribe", {soft: 1}, -65417535);VK.Widgets.Subscribe("vk_subscribe", {soft: 1}, -65417535);VK.Widgets.Subscribe("vk_subscribe", {soft: 1}, -65417535);VK.Widgets.Subscribe("vk_subscribe", {soft: 1}, -65417535);</script>   <link rel="stylesheet" href="notifi.css">';
    }
  }
//Close
